...
INSERT INTO iam_roles(id, role_key, name, data_scope, enabled, protected, created_at, updated_at)
 VALUES ('role-system-admin', 'system-admin', 'System administrator', 'all', TRUE, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO iam_menus(id, menu_key, label, path, permission_code, sort_order, protected, created_at, updated_at) VALUES
 ('menu-iam-users-01', 'iam-users', 'Users', '/iam/users', 'iam.users.read', 10, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
 ('menu-iam-roles-01', 'iam-roles', 'Roles', '/iam/roles', 'iam.roles.read', 20, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
 ('menu-iam-menus-01', 'iam-menus', 'Menus', '/iam/menus', 'iam.menus.read', 30, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
