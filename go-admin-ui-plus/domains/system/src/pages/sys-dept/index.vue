...
import { useTable, useForm, useRemove, useDict, useTreePicker, dictLabel } from '../../ui'

import { getDeptList, getDeptForForm, addDept, updateDept, delDept } from '../../api/sys-dept'
import type { SysDept, SysDeptQuery } from '../../types'
