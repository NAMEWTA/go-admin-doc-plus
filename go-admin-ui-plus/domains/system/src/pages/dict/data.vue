...
import { useTable, useForm, useRemove, useDict, dictLabel } from '../../ui'

import { listType, getType } from '../../api/dict/type'
import { listData, getDataForForm, addData, updateData, delData } from '../../api/dict/data'
import type { SysDictData, SysDictDataQuery, SysDictType } from '../../types'
