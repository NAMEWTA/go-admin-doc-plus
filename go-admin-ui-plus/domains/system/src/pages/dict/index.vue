...
import { ProTable } from '../../ui'
import { DateCell } from '../../ui'
import { STATUS_NORMAL } from '../../app-core'
import { useTable, useForm, useRemove, useDict, useExport, dictLabel } from '../../ui'

import { listType, getTypeForForm, addType, updateType, delType } from '../../api/dict/type'
import type { SysDictType, SysDictTypeQuery } from '../../types'
