...
import { closeCurrentView } from '../../app-core'
import BasicInfoForm from './basicInfoForm.vue'
import GenInfoForm from './genInfoForm.vue'
import { msgSuccess, msgError } from '../../ui'

import { getGenTable, updateGenTable, getTableTree } from '../../api/gen'
import { optionselect as getDictOptionselect } from '../../../../system/src'
import type { GenTable } from '../../api/gen'
import type { SysDictType } from '../../../../system/src'
...
const close = () => {
  return closeCurrentView(`/dev-tools/gen?t=${Date.now()}`)
}
