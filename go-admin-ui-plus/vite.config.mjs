...
import { adminRoot, adminSrc, repoRoot, rootDist } from '@go-admin/config/paths'

const resolveAdmin = dir => path.resolve(adminRoot, dir)
...
export default defineConfig(({ mode }) => {
  ...
  const env = loadEnv(mode, repoRoot, ['VITE_', 'VUE_APP_', 'NODE_'])
  ...
  return {
    ...
    plugins: [
      ...
      createSvgIconsPlugin({
        iconDirs: [resolveAdmin('src/icons/svg')],
        symbolId: 'icon-[name]'
      }),
