...
owner: unassigned
expected_changes: ["<Path>contracts/openapi/product.yaml</Path>", "<Path>go-admin-plus/internal/app/product/**</Path>", "<Path>go-admin-plus/cmd/go-admin-plus/**</Path>", "<Path>go-admin-plus-ui/packages/app-shell/src/product/**</Path>", "<Path>go-admin-plus/test/product/**</Path>", "<Path>go-admin-plus-ui/tests/e2e/product/**</Path>"]
writable_paths: ["<Path>contracts/openapi/product.yaml</Path>", "<Path>go-admin-plus/internal/app/product/**</Path>", "<Path>go-admin-plus/cmd/go-admin-plus/**</Path>", "<Path>go-admin-plus/internal/contracts/product-generated/**</Path>", "<Path>go-admin-plus-ui/packages/app-shell/src/product/**</Path>", "<Path>go-admin-plus-ui/packages/api-client/src/product-generated/**</Path>", "<Path>go-admin-plus/test/product/**</Path>", "<Path>go-admin-plus-ui/tests/e2e/product/**</Path>"]
...
shared_paths: ["<Path>contracts/openapi/product.yaml</Path>", "<Path>go-admin-plus/internal/app/product/**</Path>", "<Path>go-admin-plus-ui/packages/app-shell/src/product/**</Path>"]
shared_path_owners: ["<Path>contracts/openapi/product.yaml</Path> => T-17", "<Path>go-admin-plus/internal/app/product/**</Path> => T-17", "<Path>go-admin-plus-ui/packages/app-shell/src/product/**</Path> => T-17"]
---
