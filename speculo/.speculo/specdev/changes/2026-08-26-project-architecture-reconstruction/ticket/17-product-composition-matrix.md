...
owner: codex-root
expected_changes: ["<Path>contracts/openapi/product.yaml</Path>", "<Path>go-admin-plus/internal/app/product/**</Path>", "<Path>go-admin-plus/cmd/go-admin-plus/**</Path>", "<Path>go-admin-plus-ui/packages/app-shell/src/product/**</Path>", "<Path>go-admin-plus-ui/packages/app-shell/package.json</Path>", "<Path>go-admin-plus/test/product/**</Path>", "<Path>go-admin-plus-ui/tests/e2e/product/**</Path>"]
writable_paths: ["<Path>contracts/openapi/product.yaml</Path>", "<Path>go-admin-plus/internal/app/product/**</Path>", "<Path>go-admin-plus/cmd/go-admin-plus/**</Path>", "<Path>go-admin-plus/internal/contracts/product-generated/**</Path>", "<Path>go-admin-plus-ui/packages/app-shell/src/product/**</Path>", "<Path>go-admin-plus-ui/packages/app-shell/package.json</Path>", "<Path>go-admin-plus-ui/packages/api-client/src/product-generated/**</Path>", "<Path>go-admin-plus/test/product/**</Path>", "<Path>go-admin-plus-ui/tests/e2e/product/**</Path>"]
...
shared_paths: ["<Path>contracts/openapi/product.yaml</Path>", "<Path>go-admin-plus/internal/app/product/**</Path>", "<Path>go-admin-plus-ui/packages/app-shell/src/product/**</Path>", "<Path>go-admin-plus-ui/packages/app-shell/package.json</Path>"]
shared_path_owners: ["<Path>contracts/openapi/product.yaml</Path> => T-17", "<Path>go-admin-plus/internal/app/product/**</Path> => T-17", "<Path>go-admin-plus-ui/packages/app-shell/src/product/**</Path> => T-17", "<Path>go-admin-plus-ui/packages/app-shell/package.json</Path> => T-17 under T17-D01; product subpath export and package-local checks only"]
---
...
- **批准偏差：** `T17-D01` stage 1 只开放 app-shell package manifest 的 product subpath export 与 package-local checks。Apps、Browser/Desktop adapters、Rust bridge、根 package/Vitest/lock、模块实现和中央合同工具继续只读；只有 stage 1 失败基线证明必要后，Lead 才可串行 amendment。
