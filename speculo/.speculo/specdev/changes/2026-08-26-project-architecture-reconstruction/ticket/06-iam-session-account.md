...
owner: codex-t06-iam
expected_changes: ["<Path>contracts/openapi/modules/iam-session.yaml</Path>", "<Path>go-admin-plus/internal/modules/iam/session/**</Path>", "<Path>go-admin-plus/internal/modules/iam/account/**</Path>", "<Path>go-admin-plus/internal/platform/config/config.go</Path>", "<Path>go-admin-plus/internal/platform/config/loader_test.go</Path>", "<Path>go-admin-plus/internal/platform/config/schema_test.go</Path>", "<Path>go-admin-plus/config/schema/server-sqlite.schema.json</Path>", "<Path>go-admin-plus/config/schema/server-postgres.schema.json</Path>", "<Path>go-admin-plus/config/schema/desktop-sqlite.schema.json</Path>", "<Path>go-admin-plus-ui/package.json</Path>", "<Path>go-admin-plus-ui/tests/shell/vitest.config.ts</Path>", "<Path>go-admin-plus-ui/packages/domains/iam/package.json</Path>", "<Path>go-admin-plus-ui/packages/domains/iam/src/session/**</Path>", "<Path>go-admin-plus-ui/packages/web-domains/iam/package.json</Path>", "<Path>go-admin-plus-ui/packages/web-domains/iam/src/session/**</Path>", "<Path>go-admin-plus-ui/pnpm-lock.yaml</Path>"]
writable_paths: ["<Path>contracts/openapi/modules/iam-session.yaml</Path>", "<Path>go-admin-plus/internal/modules/iam/session/**</Path>", "<Path>go-admin-plus/internal/modules/iam/account/**</Path>", "<Path>go-admin-plus/internal/modules/iam/migrations/0010-session-*</Path>", "<Path>go-admin-plus/internal/platform/config/config.go</Path>", "<Path>go-admin-plus/internal/platform/config/loader_test.go</Path>", "<Path>go-admin-plus/internal/platform/config/schema_test.go</Path>", "<Path>go-admin-plus/config/schema/server-sqlite.schema.json</Path>", "<Path>go-admin-plus/config/schema/server-postgres.schema.json</Path>", "<Path>go-admin-plus/config/schema/desktop-sqlite.schema.json</Path>", "<Path>go-admin-plus-ui/package.json</Path>", "<Path>go-admin-plus-ui/tests/shell/vitest.config.ts</Path>", "<Path>go-admin-plus-ui/packages/domains/iam/package.json</Path>", "<Path>go-admin-plus-ui/packages/domains/iam/src/session/**</Path>", "<Path>go-admin-plus-ui/packages/web-domains/iam/package.json</Path>", "<Path>go-admin-plus-ui/packages/web-domains/iam/src/session/**</Path>", "<Path>go-admin-plus-ui/pnpm-lock.yaml</Path>", "<Path>go-admin-plus/test/iam/session/**</Path>", "<Path>go-admin-plus-ui/tests/e2e/iam/session/**</Path>"]
...
shared_path_owners: ["<Path>go-admin-plus/internal/platform/config/config.go</Path> => T-06 under T06-D02", "<Path>go-admin-plus/internal/platform/config/loader_test.go</Path> => T-06 under T06-D02", "<Path>go-admin-plus/internal/platform/config/schema_test.go</Path> => T-06 under T06-D02", "<Path>go-admin-plus/config/schema/server-sqlite.schema.json</Path> => T-06 under T06-D02", "<Path>go-admin-plus/config/schema/server-postgres.schema.json</Path> => T-06 under T06-D02", "<Path>go-admin-plus/config/schema/desktop-sqlite.schema.json</Path> => T-06 under T06-D02", "<Path>go-admin-plus-ui/package.json</Path> => T-06 under T06-D02", "<Path>go-admin-plus-ui/tests/shell/vitest.config.ts</Path> => T-06 under T06-D02"]
---
...
- `T06-D02`：首轮双轴审查确认原 Ticket 虽规定 Session idle/absolute/rotation 来自 T-03 类型化配置，却未授权三 profile 配置实现/schema；同时 IAM 测试未接入根 `pnpm verify`。Lead 于 2026-08-27 批准 T-06 只修改 frontmatter 列出的 T-03 配置文件与根前端测试入口，以加入非敏感 Session policy 和 IAM 标准门禁；禁止扩大到 kernel、其他配置域或其他前端 package。
