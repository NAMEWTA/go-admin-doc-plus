...
| T-03 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/03-runtime-profiles-observability.md</Path>` | 三 Profile 配置和生命周期 | T-02 | deep | high | yes | codex-t03-runtime | AC-005, AC-026, AC-027 | W2 / G2 | in_progress |
