...
| T-05 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/05-frontend-workspace-shell.md</Path>` | Workspace、Shell 和交互基座 | T-02 | deep | high | yes | codex-root | AC-035, AC-036 | W2 / G2 | in_progress |
