...
| T-21 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/21-atomic-cutover-contraction.md</Path>` | 原子切换与旧体系归零 | T-18, T-19, T-20 | deep | critical | yes | codex-root | AC-001, AC-002, AC-023, AC-028, AC-029, AC-033 | W10 / G7 source checkpoint c6c669b | in_progress |
