...
| T-04 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/04-dual-dialect-persistence-migrations.md</Path>` | 双方言迁移与 Database 基座 | T-03 | deep | high | yes | codex-t04-database | AC-003, AC-004, AC-024, AC-034 | W3 / G2 | in_progress |
| T-05 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/05-frontend-workspace-shell.md</Path>` | Workspace、Shell 和交互基座 | T-02 | deep | high | yes | codex-t05-frontend | AC-035, AC-036 | W2 / G2 | in_progress |
| T-06 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/06-iam-session-account.md</Path>` | Web 安全登录与账户闭环 | T-03, T-04, T-05 | deep | critical | yes | unassigned | AC-008, AC-010, AC-012, AC-025, AC-036 | W4 / G3 | ready |
| T-07 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/07-iam-administration-authorization.md</Path>` | IAM 管理与最终授权 | T-06 | deep | critical | yes | unassigned | AC-011, AC-013, AC-035, AC-036 | W5 / G3 | ready |
| T-08 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/08-reliable-runtime-no-redis.md</Path>` | 无 Redis Outbox 与唯一 executor | T-03, T-04 | deep | critical | yes | unassigned | AC-018, AC-034 | W4 / G3 | ready |
| T-09 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/09-organization-module.md</Path>` | Organization 完整管理闭环 | T-07 | deep | high | yes | unassigned | AC-014, AC-035 | W6 / G4 | ready |
...
| T-11 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/11-audit-module.md</Path>` | Audit 可靠脱敏闭环 | T-06, T-08 | deep | high | yes | unassigned | AC-016, AC-035 | W5 / G4 | ready |
...
| T-14 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/14-demo-tracer.md</Path>` | Demo 双方言 CRUD 曳光弹 | T-04, T-05, T-07 | deep | medium | yes | unassigned | AC-021, AC-024, AC-035 | W6 / G4 priority | ready |
