...
|---|---|---|---|---|---|---|---|---|---|---|
| T-01 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/01-root-governance-command-plane.md</Path>` | 根治理与统一任务入口 | — | deep | high | yes | codex-root | AC-001, AC-002 | W0 / G0 | review |
