...
| T-20 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/20-windows-nsis-release.md</Path>` | Windows x64 NSIS 候选 | T-17 | deep | critical | yes | codex-root | AC-032, AC-033 | W9 / G6 active source at main@af22c2c | in_progress |
