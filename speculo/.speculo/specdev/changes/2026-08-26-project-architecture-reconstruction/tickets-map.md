...
| T-06 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/06-iam-session-account.md</Path>` | Web 安全登录与账户闭环 | T-03, T-04, T-05 | deep | critical | yes | codex-t06-iam | AC-008, AC-010, AC-012, AC-025, AC-036 | W4 / G3 | in_progress |
