...
| T-19 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/19-macos-universal-release.md</Path>` | macOS Universal DMG 候选 | T-17 | deep | critical | yes | codex-root | AC-031, AC-033 | W9 / G6；T19-D01 packaged Generator runtime | review |
