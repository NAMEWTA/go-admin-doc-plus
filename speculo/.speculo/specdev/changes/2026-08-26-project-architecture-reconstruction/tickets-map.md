...
| T-07 | `<Path>{roots.state}/specdev/changes/2026-08-26-project-architecture-reconstruction/ticket/07-iam-administration-authorization.md</Path>` | IAM 管理与最终授权 | T-06 | deep | critical | yes | codex-t07-iam | AC-011, AC-013, AC-035, AC-036 | W5 / G3 | in_progress |
