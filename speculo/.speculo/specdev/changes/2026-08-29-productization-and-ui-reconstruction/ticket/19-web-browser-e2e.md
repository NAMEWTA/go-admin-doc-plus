...
owner: codex-root
expected_changes: ["<Path>go-admin-plus-ui/tests/e2e/**</Path>", "<Path>scripts/e2e/web/**</Path>", "<Path>go-admin-plus/test/e2e/**</Path>", "<Path>go-admin-plus/test/iam/session/browser_harness_test.go</Path>", "<Path>go-admin-plus-ui/packages/app-shell/src/product/ProductWorkspace.vue</Path>"]
writable_paths: ["<Path>go-admin-plus-ui/tests/e2e/**</Path>", "<Path>scripts/e2e/web/**</Path>", "<Path>go-admin-plus/test/e2e/**</Path>", "<Path>go-admin-plus/test/iam/session/browser_harness_test.go</Path>", "<Path>go-admin-plus-ui/packages/app-shell/src/product/ProductWorkspace.vue</Path>"]
...
# Approved deviation DEV-19-002 (USER-DECISION:all-approved): T-19 may update
# go-admin-plus/test/iam/session/browser_harness_test.go only to compose the current
...
# Approved deviation DEV-19-004 (USER-DECISION:all-approved): T-19 may update
# go-admin-plus/test/organization/browser_harness_test.go only to compose the current
# 0040 session-protection migration provider in the existing dual-dialect browser fixture.
# Product services, migration contents, assertions, and required semantics remain unchanged.
# Approved deviation DEV-19-005 (USER-DECISION:all-approved): T-19 may update
# go-admin-plus/test/settings/browser_harness_test.go only to compose the current
# 0040 session-protection migration provider in the existing dual-dialect browser fixture.
# Product services, migration contents, assertions, and required semantics remain unchanged.
# Approved deviation DEV-19-006 (USER-DECISION:all-approved): T-19 may update
# go-admin-plus/test/scheduler/browser_harness_test.go only to compose the current
# 0040 session-protection migration provider in the existing dual-dialect browser fixture.
# Product services, migration contents, assertions, and required semantics remain unchanged.
# Approved deviation DEV-19-007 (USER-DECISION:all-approved): T-19 may update
# go-admin-plus/test/demo/browser_harness_test.go only to compose the current
# 0040 session-protection migration provider in the existing dual-dialect browser fixture.
# Product services, migration contents, assertions, and required semantics remain unchanged.
# Approved deviation DEV-19-008 (USER-DECISION:all-approved): T-19 may update
# go-admin-plus/test/files/browser_harness_test.go only to compose the current
...
# 0040 session-protection migration provider in the existing dual-dialect browser fixture.
# Product services, migration contents, assertions, and required semantics remain unchanged.
# Approved deviation DEV-19-010 (USER-DECISION:all-approved): T-19 may update
# go-admin-plus-ui/tests/shell/visual-contract.spec.ts only to replace stale paused-tab
# driver assertions with exact current IAM, Organization, and Scheduler product route
# assertions. Localized label and stale-English-label checks remain unchanged.
