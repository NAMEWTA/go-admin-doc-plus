...
- **批准范围：** T-08 临时拥有 IAM administration domain controller contract 与 Web Domain administration consumer，只做旧删除调用归零、生成 DTO 适配和使候选可编译；不得提前实施 T-14 的 route/page 视觉重构。
