...
owner: codex-root
expected_changes: ["<Path>go-admin-plus/internal/host/desktop/setup*</Path>", "<Path>go-admin-plus/internal/app/product/desktop_setup*</Path>", "<Path>go-admin-plus/internal/app/product/desktop.go</Path>", "<Path>go-admin-plus/internal/app/product/desktop_control_enabled.go</Path>", "<Path>go-admin-plus/internal/app/product/desktop_control_disabled.go</Path>", "<Path>go-admin-plus-ui/apps/admin-desktop/src-tauri/src/main.rs</Path>", "<Path>go-admin-plus-ui/apps/admin-desktop/src-tauri/src/first_setup*</Path>", "<Path>go-admin-plus-ui/apps/admin-desktop/src-tauri/src/proxy.rs</Path>", "<Path>go-admin-plus-ui/apps/admin-desktop/src-tauri/src/vault.rs</Path>", "<Path>go-admin-plus-ui/apps/admin-desktop/src-tauri/build.rs</Path>", "<Path>go-admin-plus-ui/apps/admin-desktop/src-tauri/capabilities/main.json</Path>", "<Path>go-admin-plus-ui/apps/admin-desktop/src-tauri/permissions/autogenerated/desktop_first_setup_state.toml</Path>", "<Path>go-admin-plus-ui/apps/admin-desktop/src-tauri/permissions/autogenerated/desktop_first_setup_submit.toml</Path>", "<Path>go-admin-plus-ui/apps/admin-desktop/src/App.vue</Path>", "<Path>go-admin-plus-ui/apps/admin-desktop/src/first-setup/**</Path>", "<Path>go-admin-plus-ui/apps/admin-desktop/src/native-e2e/App.vue</Path>"]
...
- **DEV-10-001（USER-DECISION:all-approved）：** T-10 可写入 front matter 新增的现有 Desktop composition/private-route、生产 `App.vue`、Rust proxy、Tauri manifest/capability 与自动生成 command permission 路径。setup transport 必须保持在 loopback control-token 边界内；密码与原始 Session/CSRF 只能在 native command/Rust vault 短暂存在，WebView 只接收 setup state、严格校验后的公开 Profile 与完成/恢复信号。禁止公开 HTTP Bootstrap endpoint 与客户端持久化 setup flag。
