...
| T-04 | `<Path>{roots.state}/specdev/changes/2026-08-29-productization-and-ui-reconstruction/ticket/04-organization-data-scopes.md</Path>` | 组织归属与五种数据范围 | — | deep | critical | yes | codex-root | AC-019~022 | A / Authorization Prefactor | review |
