...
| T-11 | `<Path>{roots.state}/specdev/changes/2026-08-29-productization-and-ui-reconstruction/ticket/11-ui-design-system.md</Path>` | Element Plus token 与共享管理组件 | — | standard | high | yes | unassigned | AC-017, AC-018 | A / UI Prefactor | ready |
