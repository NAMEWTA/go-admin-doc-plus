...
| T-18 | `<Path>{roots.state}/specdev/changes/2026-08-29-productization-and-ui-reconstruction/ticket/18-postgres-security-ci-gates.md</Path>` | 真实 PostgreSQL 与安全供应链 CI | T-01, T-09, T-17 | deep | high | yes | codex-root | AC-002, AC-006, AC-008, AC-019, AC-023, AC-027, AC-030, AC-035, AC-037 | G / Required CI | in_progress |
