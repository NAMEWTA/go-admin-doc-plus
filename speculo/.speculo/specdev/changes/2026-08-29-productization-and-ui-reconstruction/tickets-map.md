...
| T-10 | `<Path>{roots.state}/specdev/changes/2026-08-29-productization-and-ui-reconstruction/ticket/10-desktop-first-setup.md</Path>` | Desktop 原生首次设置与 Session 转换 | T-02, T-09, T-13 | deep | critical | yes | codex-root | AC-004, AC-005, AC-031 | E / Desktop Setup | in_progress |
