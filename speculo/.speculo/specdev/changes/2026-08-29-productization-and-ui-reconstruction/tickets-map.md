...
| T-06 | `<Path>{roots.state}/specdev/changes/2026-08-29-productization-and-ui-reconstruction/ticket/06-file-capacity-governance.md</Path>` | 配额、磁盘水位与崩溃对账 | — | deep | high | yes | codex-root | AC-027~029 | A / Storage Prefactor | review |
