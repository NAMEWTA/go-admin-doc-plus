...
| T-12 | `<Path>{roots.state}/specdev/changes/2026-08-29-productization-and-ui-reconstruction/ticket/12-router-workspace-shell.md</Path>` | Vue Router 单一事实源与双宿主 Shell | T-11 | deep | high | yes | codex-root | AC-014~018 | B / Shell Gate | in_progress |
