...
| T-15 | `<Path>{roots.state}/specdev/changes/2026-08-29-productization-and-ui-reconstruction/ticket/15-operations-pages-ui.md</Path>` | Audit/Settings/Scheduler 成熟页面 | T-11, T-12 | standard | medium | yes | codex-root | AC-014~018, AC-038 | D / Operations UI | in_progress |
