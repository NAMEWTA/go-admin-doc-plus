...
| T-09 | `<Path>{roots.state}/specdev/changes/2026-08-29-productization-and-ui-reconstruction/ticket/09-product-cli-runtime-topology.md</Path>` | 单一产品 CLI 与三 Profile 拓扑 | T-07, T-08 | deep | critical | yes | unassigned | AC-029~033 | D / Runtime Gate | ready |
