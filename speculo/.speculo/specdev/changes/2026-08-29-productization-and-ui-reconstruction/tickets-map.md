...
| T-05 | `<Path>{roots.state}/specdev/changes/2026-08-29-productization-and-ui-reconstruction/ticket/05-account-deletion-lifecycle.md</Path>` | Tombstone、会话撤销与文件处置 | T-02, T-04 | deep | critical | yes | codex-root | AC-013, AC-023~026 | B / Lifecycle | in_progress |
