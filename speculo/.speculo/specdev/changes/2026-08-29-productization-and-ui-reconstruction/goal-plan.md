...
| Workspace records | T-20 latest source `37c6841`、portable candidate `822936e`/tree `d593fb1` 已记录并通过 portable checks；probe `20c6b63` 的 DEV-20-014 attempt 1 `login-demo-workspace` 红灯保留，既有 source/candidate、probe、扫描 artifacts 与旧失败候选继续保留 |
