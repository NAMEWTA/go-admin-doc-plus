...
| Workspace records | T-20 latest source `7d06b78`、portable candidate `ec10a49`/tree `0660525` 已记录并通过 portable checks；probe `1ae5049` 的 DEV-20-011 attempt 2 `login-demo-workspace` 红灯保留，既有 source/candidate、probe、扫描 artifacts 与旧失败候选继续保留 |
