...
| Tickets | T-01~T-14 均 `done`；T-15~T-21 `ready` |
| Gate | G0~G2 已通过；G3 已完成 T-09/T-10/T-13/T-14，等待 T-15/T-16；G4~G8 尚未开启 |
| Workspace records | T-14 source `1ceefc1`、candidate/result `49c690c` 已记录；所有 source/candidate 与旧失败候选继续保留 |
...
T-14 已完成并晋升 result `49c690c`：五个业务 route、组织归属、五种数据范围和 transfer/purge/queued/claimed 删除状态均有确定性 domain/component 证明；DEV-14-001 只补齐两个直接 `vue-router` manifest/importer。T-19 继续持有真实浏览器流程，T-20 仍等待 T-15/T-16/T-19；所有 source/candidate 与保护 stash 均保留。
