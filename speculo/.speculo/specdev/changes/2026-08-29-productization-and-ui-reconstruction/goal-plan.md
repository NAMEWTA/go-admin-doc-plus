...
| Workspace records | T-20 latest source `075a043`、portable candidate `f1e7b28`/tree `a375d05` 已记录并通过 portable checks；probe `f062e11` 的 DEV-20-014 attempt 2 `login-demo-workspace` 红灯保留，既有 source/candidate、probe、扫描 artifacts 与旧失败候选继续保留 |
