...
| Tickets | T-01~T-16 均 `done`；T-17 `in_progress`；T-18~T-21 `ready` |
| Gate | G0~G3 已通过；G4/T-17 执行中；G5~G8 尚未开启 |
| Workspace records | T-16 source `40babcc`、candidate/result `6b9fe9c` 已记录；T-17 从 `main@ace3785` 冻结 source base；所有 source/candidate 与旧失败候选继续保留 |
