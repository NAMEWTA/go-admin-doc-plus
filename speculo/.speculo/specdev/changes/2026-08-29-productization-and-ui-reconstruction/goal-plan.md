...
| Tickets | T-01/T-02/T-03/T-04/T-06/T-11 `in_progress`；T-07 `review`；T-05/T-08~T-10、T-12~T-21 `ready` |
| Gate | G0 已关闭；G1~G8 关闭 |
| Workspace records | T-01/T-02/T-03/T-04/T-06/T-11 `blocked`（实现提交已固定，等待所列 runner/owning Ticket 门禁）；T-07 `review`；其余 Ticket 待依赖满足后建立 |
