...
| Parent | `main@83c63d6a0695525fbe72909e6f710d1239360ce0`；执行时每 Ticket 重读 |
| Tickets | T-01/T-02 `in_progress`；T-03~T-21 `ready` |
| Gate | G0 已关闭；G1~G8 关闭 |
| Workspace records | T-01/T-02 `active`；其余 Ticket 待依赖满足后建立 |
