...
export default defineConfig({ root: fileURLToPath(new URL('.', import.meta.url)), plugins:[vue()], resolve:{alias:{'@go-admin-plus/web-domain-generator':resolve(workspaceRoot,'packages/web-domains/generator/src/index.ts'),'@go-admin-plus/domain-generator':resolve(workspaceRoot,'packages/domains/generator/src/index.ts'),'@go-admin-plus/domain-iam/administration':resolve(workspaceRoot,'packages/domains/iam/src/administration/index.ts'),'@go-admin-plus/domain-iam/session':resolve(workspaceRoot,'packages/domains/iam/src/session/index.ts'),'@go-admin-plus/web-domain-iam/administration':resolve(workspaceRoot,'packages/web-domains/iam/src/administration/index.ts'),'@go-admin-plus/web-domain-iam/session':resolve(workspaceRoot,'packages/web-domains/iam/src/session/index.ts'),'@go-admin-plus/ui/components':resolve(workspaceRoot,'packages/ui/src/components/runtime.mts'),'@go-admin-plus/ui':resolve(workspaceRoot,'packages/ui/src/index.ts'),vue:resolve(workspaceRoot,'packages/web-domains/generator/node_modules/vue')}},server:{proxy:process.env.GO_ADMIN_GENERATOR_E2E_API_TARGET?{'/api':{target:process.env.GO_ADMIN_GENERATOR_E2E_API_TARGET,secure:false}}:undefined},build:{outDir:output,emptyOutDir:true} })
