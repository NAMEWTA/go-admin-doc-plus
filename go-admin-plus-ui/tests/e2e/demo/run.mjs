...
const keys = ['CC','CGO_ENABLED','GOCACHE','GOENV','GOMODCACHE','GOPATH','GOPROXY','GOROOT','GOSUMDB','GOTOOLCHAIN','HOME','LANG','LC_ALL','PATH','PNPM_HOME','SSL_CERT_DIR','SSL_CERT_FILE','TEMP','TMP','TMPDIR','USERPROFILE']
