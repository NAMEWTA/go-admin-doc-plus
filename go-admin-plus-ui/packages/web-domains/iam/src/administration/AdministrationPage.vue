...
<template>
  <main class="administration-page">
    ...
    <section v-if="tab === 'users'" aria-labelledby="users-heading">
    ...
    <section v-else-if="tab === 'roles'" aria-labelledby="roles-heading">
    ...
    <section v-else aria-labelledby="menus-heading">
